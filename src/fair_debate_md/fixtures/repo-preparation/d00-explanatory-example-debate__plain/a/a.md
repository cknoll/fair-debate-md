...
Each contribution consists of *statements*. A statement can be a sentence, a bullet point, a headline etc. Contributions are automatically split into statements. Each statement has its own key and thus is uniquely referenceable. Now, the two main features of *Fair Debate* are:
